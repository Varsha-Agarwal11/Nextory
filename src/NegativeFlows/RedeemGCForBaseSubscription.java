...
public class RedeemGCForBaseSubscription extends SuperTestScript
{
	...
	public RedeemGCForBaseSubscription()
	{
		loginRequired=false;
	...
	//------------------------------Not Entrying The Gift Card Voucher Code--------------------------------------
	...
	public void redeemGiftCardNewUserWithDifferentEmailId() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		adminUn = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINUN");
		adminPwd = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINPWD");
		adminUrl = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINURL");
