...
public class RedeemGCForPremiumSubscription extends SuperTestScript
{
   ...
   public RedeemGCForPremiumSubscription()
   {
	   loginRequired=false;
 ...
 //-----------------------------Redeem GiftCard for Premium Subscription---------------------------------//
 	...
 	public void redeemGCNewUserEntryingIncorrectDetails() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	    ...
	    String actualPasswordMsg=driver.findElement(By.xpath("//label[text()='Ditt lösenord måste vara mellan 4 och 25 tecken.']")).getText();
	...
	//--------------------------------Using Different Email Id's-----------------------------------------------
	@Test(enabled=true, priority=3, groups={"NegativeFlows" , "All"})
 	public void redeemGiftCardPremiumNewUserWithDifferentEmailIds() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		adminUn = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINUN");
		adminPwd = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINPWD");
		adminUrl = Property.getPropertyValue(CONFIG_PATH + CONFIG_FILE, "ADMINURL");
