...
public class Inactive7Days extends SuperTestScript 
{
  ...
  @Test(enabled=true, priority=230,groups = {"AntiChurnRuleMailerPositive", "All"})
   public void inactive7DaysTC110301()
   {
		log.info("------------------------------In Inactive 7 days Script Positive-------------------------------");
  ...
  @Test(enabled=true, priority=231, groups = {"AntiChurnRuleMailerNegative", "All"})
  public void inactive7Days()
  {
		log.info("---------------------------------In Inactive 7 days Script Negative---------------------------");
