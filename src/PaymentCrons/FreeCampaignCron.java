...
public class FreeCampaignCron extends SuperTestScript
{
	...
	public FreeCampaignCron()
	{
		loginRequired=false;
		logoutRequired=false;
	}
	
	//----------------------------------FREE CAMPAIGN PAYMENT CRON SUCCESS AT DAY 1-------------------------------------//
	@Test
	public void runFreeCampaignCronSuccess()
	{
		customerId = Database.executeQuery("select customerid from customerinfo where member_type_code=202002 order by rand() limit 1");
		log.info("Customer Id of the Free Campaign Member is : " +customerId);
		...
		Assert.assertEquals(previousMemTypeCode, "202002");
		log.info("PREVIOUS MEMBER_TYPE WAS: FREE_CAMPAIGN_MEMBER");	//Validating if the previous Member Type was FREE_CAMPAIGN_MEMBER or Not.
	...
	//---------------------------------- FREE CAMPAIGN PAYMENT CRON FAILS AT DAY 1, DAY 3 and DAY 7----------------------------//

	@Test
	public void runFreeCampaignCronFailure()
	{
		// Failing at Day 1 //
		...
		Assert.assertEquals(presentMemTypeCode, "402005");
		log.info("CURRENT MEMBER_TYPE IS : NONMEMBER_PREVIOUS_CAMPAIGN");			//Validating if the current Member Type gets converted to NONMEMBER_PREVIOUS_CAMPAIGN or not.	
	...
	//---------------------------------- FREE CAMPAIGN PAYMENT CRON FAILS AT DAY 1 and SUCCESS AT DAY 3----------------------------//	
	
	@Test
	public void runFreeCampaignCronSuccessAtThree()
	{
		// Failing at Day 1 //
	...
	//---------------------------------- FREE CAMPAIGN PAYMENT CRON FAILS AT DAY 1, DAY 3 and SUCCESS AT DAY 7----------------------------//				
	@Test
	public void runFreeCampaignCronSuccessAtSeven()
	{
		// Failing at Day 1 //
